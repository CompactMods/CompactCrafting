package dev.compactmods.crafting.test.testers.component;

import dev.compactmods.crafting.api.components.IRecipeComponents;
import dev.compactmods.crafting.api.field.MiniaturizationFieldSize;
import dev.compactmods.crafting.test.testers.ITestableAreaHelper;
...
public class ComponentTestHelper {
    ...
    public ComponentTestHelper(GameTestHelper testHelper, IRecipeComponents components) {
