...
//    }
    ...
    public void extractRenderState(FieldProjectorEntity blockEntity, FieldProjectorRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
        ...
        state.currentState = blockEntity.getBlockState();
    }
...
//        BakedModel baked = this.getModel();
        ...
        poseStack.pushPose();
        {
            ...
            Direction facing = renderState.currentState.getValue(FieldProjectorBlock.FACING);
            ...
            float red = ARGB.red(faceColor) / 255f;
            float green = ARGB.green(faceColor) / 255f;
            float blue = ARGB.blue(faceColor) / 255f;
