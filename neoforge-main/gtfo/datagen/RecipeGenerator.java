...
public class RecipeGenerator extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ShapelessRecipeBuilder.shapeless(CCItems.FIELD_PROJECTOR_ITEM.get(), 1)
                ...
                .unlockedBy("got_ender_eye", RecipeProvider.has(Items.ENDER_EYE))
                .save(consumer);
        ...
        ShapelessRecipeBuilder.shapeless(CCItems.MATCH_PROXY_ITEM.get())
                ...
                .unlockedBy("got_redstone", RecipeProvider.has(Items.REDSTONE))
                .save(consumer);

        ShapelessRecipeBuilder.shapeless(CCItems.RESCAN_PROXY_ITEM.get())
                .requires(CCItems.BASE_ITEM.get())
                .requires(Items.CRAFTING_TABLE)
                .unlockedBy("got_crafting_table", RecipeProvider.has(Items.CRAFTING_TABLE))
                .save(consumer);
    }
}
