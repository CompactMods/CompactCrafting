...
public abstract class JsonUtil {
    ...
    public static Optional<RecipeBlockStateComponentMatcher> getPossibleStates(JsonObject root) {
        ...
        RecipeBlockStateComponentMatcher matcher = new RecipeBlockStateComponentMatcher(b);
